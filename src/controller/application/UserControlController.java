...
public class UserControlController implements Initializable {
    ...
    public void btnEmployeeOnAction(ActionEvent event) throws IOException {
        ...
        fXMLLoader.load(getClass().getResource("/view/application/usercontrol/ViewEmployee.fxml").openStream());
        media.setId(usrId);
...
//    }
    ...
    private void btnProjectOnAction(ActionEvent event) throws IOException {
        ...
        userNameMedia media = new userNameMedia();
        FXMLLoader fXMLLoader = new FXMLLoader();
        fXMLLoader.load(getClass().getResource("/view/application/usercontrol/ViewProject.fxml").openStream());
        media.setId(usrId);
 ...
 // Added for Department Tab
    ...
    private void btnDepartmentOnAction(ActionEvent event) throws IOException {
        ...
        userNameMedia media = new userNameMedia();
        FXMLLoader fXMLLoader = new FXMLLoader();
        fXMLLoader.load(getClass().getResource("/view/application/usercontrol/ViewDepartment.fxml").openStream());
        media.setId(usrId);
    ...
    private void btnBugTrackOnAction(ActionEvent event) throws IOException {
        ...
        userNameMedia media = new userNameMedia();
        FXMLLoader fXMLLoader = new FXMLLoader();
        fXMLLoader.load(getClass().getResource("/view/application/usercontrol/ViewBug.fxml").openStream());
        media.setId(usrId);
