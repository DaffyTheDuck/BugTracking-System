...
public class LoginController implements Initializable {
    ...
    ObservableList<String> list1 = FXCollections.observableArrayList("Admin","Manager","Employee");
    ...
    @FXML
    private void cmbUserTypeOnSelect(ActionEvent event) {
        try {
            btnLogin(event);
        } catch (IOException ex) {
            ex.printStackTrace();
    ...
    private void loadRegistration() {
        ...
        try {
            ...
            nStage.setTitle("Registration -BugTracking");
            nStage.show();
    ...
    private void hlDbOnAction(ActionEvent event) {
        ...
        try {
            ...
            nStage.setTitle("Server Status -BugTracking");
            nStage.show();
        } catch (IOException e) {
            e.printStackTrace();
        }
