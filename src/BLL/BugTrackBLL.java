...
public class BugTrackBLL {
    ...
    public boolean isUpdate(BugTrack bug) {
        ...
        try {
            pst = con.prepareStatement("select * from "+ db +".BugTrack where Id=? and BugId=? and BugName=? and BugType=? and BugLevel=? and Severity=? and ProjectName=? and TesterCode=? and RaisedOn=? and DeveloperCode=? and Status=? and Solution=?");
