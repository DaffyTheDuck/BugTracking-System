...
public class ReportBLL {
	...
	public Object delete(Report report){
	 ...
	 public void update(Report report) {
	        ...
	        if(isNotNull(report)){
	        	reportGetway.updateReport(report);
	        	
//	            if (isUpdate(report)) {
//	                    if (checkUpdateCondition(report)) {
//	                    	System.out.println("Inside ReportBLL update(11)...");
//	                    	reportGetway.updateReport(report);
//	                    } else if (isUniqName(report)) {
//	                    	System.out.println("Inside ReportBLL update(12)...");
//	                    	reportGetway.updateReport(report);
//	            }
//	        }
	        }
	...
	public boolean isUpdate(Report report) {
        ...
        try {
        	...
        	pst = con.prepareStatement("select * from " + db + "; update .Report SET ReportId=? and ReportName=? and BugName=? and Severity=? and ProjectName=? and RaisedDate=? and Status=? and ResolvedDate=? where Id=?");
